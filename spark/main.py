...
if __name__ == "__main__":
    ...
    print("\n> Stage 0 execution time:", execution_time, "s")
    ...
    execution_time = time.time() - start_time_stage1
    print("\n> Stage 1 execution time:", execution_time, "s")
    ...
    execution_time = time.time() - start_time_stage2
    print("\n> Stage 2 execution time:", execution_time, "s")
